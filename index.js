! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t(require("lodash")) : "function" == typeof define && define.amd ? define(["lodash"], t) : "object" == typeof exports ? exports.arrz = t(require("lodash")) : e.arrz = t(e.lodash) }(this, (function(e) {
    return (() => {
        var t = {
                826: e => {
                    ...
                    e.exports = a, e.exports.has = function(e) { return !!e.match(n) }, e.exports.remove = a
                },
                356: t => {
                    "use strict";
                    t.exports = e
        ...
        return (() => {
            "use strict";
            o.r(n), o.d(n, { contains: () => h, countByCondition: () => s, doesNotContain: () => y, filterAndSort: () => p, filterValues: () => f, filterWithFuncObjectOrString: () => E, getOneMakeChildOfAnother: () => I, getUnique: () => k, group: () => m, makeChildOfAnother: () => A, makeChildOfAnotherTest: () => S, mergeByKeys: () => w, sortAsc: () => c, sortDesc: () => d, testFilterWithFuncStringObject: () => U, testMergeByKeys: () => O, testUnique: () => C, trimArr: () => u });
            var e = o(356);
            o(826);
                ...
                return function(e) { if (Array.isArray(e)) return e }(e) || function(e, t) {
                    ...
                    if (null != r) {
                        var o, n, a = [],
                            i = !0,
                            u = !1;
                        try { for (r = r.call(e); !(i = (o = r.next()).done) && (a.push(o.value), !t || a.length !== t); i = !0); } catch (e) { u = !0, n = e } finally { try { i || null == r.return || r.return() } finally { if (u) throw n } }
                        return a
                    }
            ...
            function u(e) {
                for (var t = 0; t < e.length; t++)
                    for (var o = 0, n = Object.entries(e[t]); o < n.length; o++) {
                        var a = r(n[o], 2),
                            i = a[0],
                            u = a[1];
                        if ("string" == typeof u) {
            ...
            function l(e, t, r) { return e.filter((function(e) { if (-1 !== e[t].toLowerCase().indexOf(r.toLowerCase())) return e })) }

            function f(r, o, n) {
                for (var a, i, s, f = [], c = (s = [], (i = r) || (i = {}), (a = o) || (a = ""), i.forEach((function(e, t) { for (var r in e) e.hasOwnProperty(r) && e[r] && -1 !== e[r].toString().indexOf(a) && s.push(e) })), s), d = 0; d < n.length; d++) {
                    var h = l(c, n[d], o);
                    f = [].concat(t(f), t(h))
                }
                return u(f = (0, e.uniqWith)(f, e.isEqual))
            }

            function c(t, r, o) {
                if ("date" === o)
                    for (var n = 0; n < t.length; n++) "string" == typeof t[n][r] ? t[n][r] = new Date(t[n][r]) : t[n][r] = t[n][r];
                return u((0, e.sortBy)(t, [r]))
            }

            function d(t, r, o) {
                if ("date" === o)
                    for (var n = 0; n < t.length; n++) "string" == typeof t[n][r] ? t[n][r] = new Date(t[n][r]) : t[n][r] = t[n][r];
                return u((0, e.sortBy)(t, [r]).reverse())
            }

            function h(e, t, r) { for (var o = [], n = 0; n < e.length; n++) e[n][t] === r && o.push(e[n]); return u(o) }
            ...
            function p(t, r, o, n) {
                var a = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4],
                    ...
                    s = (0, e.filter)(t, r),
                    l = (0, e.sortBy)(s, [o]);
                if (l = !1 === a ? d(l, o, n) : c(l, o, n), i) { var f = l.slice(0, i); return u(f) }
                return u(l)
            }

            function m(t, r) { return u((0, e.groupBy)(t, r)) }
            ...
            function v(e) {
                for (var t = 1; t < arguments.length; t++) {
                    ...
                    t % 2 ? b(Object(r), !0).forEach((function(t) { g(e, t, r[t]) })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(r)) : b(Object(r)).forEach((function(t) { Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(r, t)) }))
                }
                return e
            }

            function g(e, t, r) { return t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e }

            function w(t, r) { var o = {}; return o[r.key] = r.value, (0, e.map)(t, (function(t) { return (0, e.merge)(t, (0, e.find)(r.data, o)) })) }

            function O() {
                var e = w([{ title: "I want to be free. Free to live,  and to find my own way,  to love,  or to be alone,  but at least it is my choice,  and I am so tired of not having choices,  so scared of the years rushing past beneath my feet. I do not want to die as I’ve lived,  which is no life at all.", status: "to do", id: 1 }, { title: "Because we loved each other too much and found each other too interesting. And I love that about humanity,  and in fact it’s the very reason I root for us to survive—because we are so stupid about each other.", status: "doing", id: 2 }, { title: "But a life without art,  without wonder,  without beautiful things—she would go mad. She has gone mad. What she needs are stories. Stories are a way to preserve one’s self. To be remembered. And to forget.", status: "doing", id: 3 }], { data: [{ name: "Whatever", status: "doing", problem_id: 2, id: 1 }, { name: "is", status: "doing", problem_id: 2, id: 2 }, { name: "people", status: "to do", problem_id: 2, id: 3 }], key: "problem_id", value: 2 });
                console.log(e)
            }

            function A(e, t) { return e.data.map((function(r) { return v(v({}, r), {}, { child: t.data.filter((function(o) { return r[e.key] === o[t.key] })).map((function(e) { return e })) }) })) }

            function I(t, r) {
                var o = {};
                o[r.key] = r.value;
                var n = t.data.map((function(e) { return v(v({}, e), {}, { child: r.data.filter((function(o) { return e[t.key] === o[r.key] })).map((function(e) { return e })) }) })),
                    a = (n.filter((function(e) { return o })), {});
                return a[t.key] = t.value, (0, e.filter)(n, a)
            }

            function S() {
                var e = [{ title: "I want to be free. Free to live,  and to find my own way,  to love,  or to be alone,  but at least it is my choice,  and I am so tired of not having choices,  so scared of the years rushing past beneath my feet. I do not want to die as I’ve lived,  which is no life at all.", status: "to do", id: 1 }, { title: "Because we loved each other too much and found each other too interesting. And I love that about humanity,  and in fact it’s the very reason I root for us to survive—because we are so stupid about each other.", status: "doing", id: 2 }, { title: "But a life without art,  without wonder,  without beautiful things—she would go mad. She has gone mad. What she needs are stories. Stories are a way to preserve one’s self. To be remembered. And to forget.", status: "doing", id: 3 }],
                    ...
                    r = I({ data: e, key: "id", value: 2 }, { data: t, key: "problem_id", value: 2 });
                console.log(r);
                var o = A({ data: e, key: "id" }, { data: t, key: "problem_id" });
                console.log(o)
            }
            ...
            function k(e, t) { return function(e) { return function(e) { if (Array.isArray(e)) return x(e) }(e) || function(e) { if ("undefined" != typeof Symbol && null != e[Symbol.iterator] || null != e["@@iterator"]) return Array.from(e) }(e) || function(e, t) { if (e) { if ("string" == typeof e) return x(e, t); var r = Object.prototype.toString.call(e).slice(8, -1); return "Object" === r && e.constructor && (r = e.constructor.name), "Map" === r || "Set" === r ? Array.from(e) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? x(e, t) : void 0 } }(e) || function() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.") }() }(new Map(e.map((function(e) { return [e[t], e] }))).values()) }
            var P = [{ id: 1, hello: "whatsup" }, { id: 2, hello: "whatsup" }, { id: 1, hello: "whatsup" }];
