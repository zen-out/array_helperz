        ...
        var t = {
                ...
                150: e => {
                    ...
                    function t(e, t, o, r, n) {
                        "object" != typeof e && Boolean(e.toString().match(n)) && !t.some((t => Object.is(t, e))) && t.push(e), Object.keys(e).forEach((a => {
                            const i = r ? o.includes(a) : !o.includes(a);
        ...
        return (() => {
            ...
            function i(e) {
                for (var t = 0; t < e.length; t++)
                    for (var r = 0, n = Object.entries(e[t]); r < n.length; r++) {
                        var a = o(n[r], 2),
                            i = a[0],
                            u = a[1];
                        if ("string" == typeof u) {
            ...
            function l(t, o, r) {
                if ("date" === r)
                    for (var n = 0; n < t.length; n++) "string" == typeof t[n][o] ? t[n][o] = new Date(t[n][o]) : t[n][o] = t[n][o];
                return i((0, e.sortBy)(t, [o]))
            }

            function c(t, o, r) {
                if ("date" === r)
                    for (var n = 0; n < t.length; n++) "string" == typeof t[n][o] ? t[n][o] = new Date(t[n][o]) : t[n][o] = t[n][o];
                return i((0, e.sortBy)(t, [o]).reverse())
            }
            ...
            function h(t, o, r, n) {
                var a = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4],
                    ...
                    s = (0, e.filter)(t, o),
                    f = (0, e.sortBy)(s, [r]);
                if (f = !1 === a ? c(f, r, n) : l(f, r, n), u) { var d = f.slice(0, u); return i(d) }
                return i(f)
            }
            ...
            function p(e, t) {
                ...
                if (Object.getOwnPropertySymbols) {
                    ...
                    t && (r = r.filter((function(t) { return Object.getOwnPropertyDescriptor(e, t).enumerable }))), o.push.apply(o, r)
                }
                return o
            }
            ...
            function m(e) {
                for (var t = 1; t < arguments.length; t++) {
                    ...
                    t % 2 ? p(Object(o), !0).forEach((function(t) { b(e, t, o[t]) })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o)) : p(Object(o)).forEach((function(t) { Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(o, t)) }))
                }
                return e
            }
            ...
            function O(t, o) {
                var r = {};
                r[o.key] = o.value;
                var n = t.data.map((function(e) { return m(m({}, e), {}, { child: o.data.filter((function(r) { return e[t.key] === r[o.key] })).map((function(e) { return e })) }) })),
                    a = (n.filter((function(e) { return r })), {});
            ...
            function A() {
                ...
                console.log(o);
                var r = w({ data: e, key: "id" }, { data: t, key: "problem_id" });
                console.log(r)
            }
            ...
            function j(t, o) {
                ...
                if ("function" == typeof o) t.filter(o);
                else { if ("string" == typeof o && "string" == typeof r) { var n = f(t, o, r); return n } if ("object" === I(o)) return (0, e.filter)(t, o); if ("string" == typeof o) return s(t, "", [o]) }
                var a = (0, e.filter)(t, o);
                return a
            }
            ...
            var U = [{ id: 1, hello: "whatsup" }, { id: 2, hello: "whatsup" }, { id: 1, hello: "whatsup" }];
